<div class="wrap">
<h2>WP Real Estate - <?php _e( 'Property Type', 'wp-realestate' ); ?></h2><br />
<style>
...
<a id="add_property_type_submit" class="button button-primary" href=""><?php _e( 'Add Property Type', 'wp-realestate' ); ?></a>
...
if($get_property_type!=""){
	if (strpos($get_property_type,',') !== false) {
		...
		foreach($arr_property_type_text as $propertytype){
			...
			echo '<td width="10%"><a id="p_delete" class="button" href="javascript:p_delete(\''.$propertytype.'\');">'.__( 'Delete', 'wp-realestate' ).'</a></td>';
			echo '</tr>';
		}
	} else {
		echo '<tr class="et_et_'.$propertytype.'">';
		echo '<td width="80%">'.$get_property_type.'</td>';
		echo '<td width="10%"><a id="p_delete" class="button" href="javascript:p_delete(\''.$get_property_type.'\');">'.__( 'Delete', 'wp-realestate' ).'</a></td>';
		echo '</tr>';
	}
}
