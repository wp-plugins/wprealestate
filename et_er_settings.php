...
<?php endforeach; ?>
    ...
    <tr>
      <td>Display Property ID (in listing)</td>
      <td><select name="p_pro_id_display" id="p_pro_id_display">
        <option value="1" <?php if ($p_pro_id_display == 1) {?> selected="selected"<?php } ?>>Yes</option>
        <option value="0" <?php if ($p_pro_id_display == 0) {?> selected="selected"<?php } ?>>No</option>
      </select></td>
    </tr>
    <tr>
      <td>Max Property Photos</td>
      <td><input name="p_num_slider_pics" type="text" id="p_num_slider_pics" value="<?php echo $p_num_slider_pics; ?>" /></td>
    </tr>
    <tr>
      <td>Display social share buttons</td>
      <td><select name="p_share_buttons" id="p_share_buttons">
        <option value="1" <?php if ($p_share_buttons == 1) {?> selected="selected"<?php } ?>>Yes</option>
        <option value="0" <?php if ($p_share_buttons == 0) {?> selected="selected"<?php } ?>>No</option>
      </select></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<form id="form2" name="form2" method="post" action="">
  <table width="465" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      <td><strong>Note</strong>: <em>Please fill the fields in property details if you have enabled the fields to be searchable below.</em></td>
    </tr>
    <tr>
