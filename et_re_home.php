<h1>WP Real Estate - <?php _e( 'Home', 'wp-realestate' ); ?></h1>
<?php
...
<p>A quick  video tutorial is located here <a href="http://www.modulates.com/videos/how-to-build-a-real-estate-or-property-listing-website" target="_blank">http://www.modulates.com/videos/how-to-build-a-real-estate-or-property-listing-website</a></p>
...
<ul style="list-style: disc inside none;">
  ...
  <li>Separate rent and sale price</li>
  <li>Unlimited property photos can be added</li>
  <li>Enable/Disable social sharing</li>
  <li>Custom property types have been added. You can add or manage your own <a href="admin.php?page=WPRealEstatePropertyType">custom property types from here</a>.</li>
  <li>Advanced property search has been added. You can customize the form by selecting what fields you want to use for <a href="admin.php?page=WPRealEstateSettings">advanced search from here</a>.</li>
  <li>Also make sure you have selected the correct property listing page.</li>
</ul>', 'wp-realestate' );
?>
<div style="width: 50%; float: left;">
    <h3><?php _e( 'How to create a Real Estate or Property Listing website in 10 minutes', 'wp-realestate' );?></h3>
    <iframe style="width:100%;max-width:640px;" height="360" src="http://www.modulates.com/embed/index.php?key=233_nJA8eInIEPZZbU5qv5NO0NFw3&width=640&height=360" frameborder="0" allowfullscreen scrolling="no"></iframe>
</div>
<div style="width: 50%; float: left;">
...
<hr />
<?php _e( '<p>Would you like us to feature your website in our show case? Please send us your name, email and website address to <a href="mailto:hozyali@gmail.com">hozyali@gmail.com</a> and we will be glad to feature your website using WP Real Estate on our website\'s show case.</p>', 'wp-realestate' ); ?>
