...
define( 'ET_RE_URL', plugins_url('/wprealestate') );
...
function et_er_AdminMenu() {
	global $PluginDirName, $PluginName;
	add_menu_page($PluginName." Configuration", $PluginName, 'edit_themes', $PluginName."Home", 'et_er_HomeView');
	add_submenu_page( $PluginName."Home", "Settings", "Settings", 'edit_themes', $PluginName."Settings", 'et_er_settings' );
	/*add_submenu_page( $PluginName."Home", "Add New Customer", "Add Customer", 'edit_themes', $PluginName."Users", 'md_add_users' );
	add_submenu_page( $PluginName."Home", "View Clients", "View Clients", 'edit_themes', $PluginName."Clients", 'md_view_billing' );
	add_submenu_page( $PluginName."Home", "Client Videos", "Client Videos", 'edit_themes', $PluginName."Videos", 'md_Videos' );
	add_submenu_page( $PluginName."Home", "View Referral", "View Referral", 'edit_themes', $PluginName."-Referral", 'md_view_referral' );
	add_submenu_page( $PluginName."Home", "View Plans", "View Plans", 'edit_themes', $PluginName."-Plans", 'md_view_plans' );
	add_submenu_page( $PluginName."Home", "Add Plan", "Add Plan", 'edit_themes', $PluginName."-AddPlan", 'md_add_plans' );*/
