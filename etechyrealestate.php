...
function custom_taxonomy_facilities()  {
	...
	$labels2 = array(
		'name'                       => _x( 'States', 'Taxonomy General Name', 'wp-realestate' ),
		'singular_name'              => _x( 'State', 'Taxonomy Singular Name', 'wp-realestate' ),
		'menu_name'                  => __( 'State', 'wp-realestate' ),
		'all_items'                  => __( 'All States', 'wp-realestate' ),
		'parent_item'                => __( 'Parent State', 'wp-realestate' ),
		'parent_item_colon'          => __( 'Parent State:', 'wp-realestate' ),
		'new_item_name'              => __( 'New State Name', 'wp-realestate' ),
		'add_new_item'               => __( 'Add New State', 'wp-realestate' ),
		'edit_item'                  => __( 'Edit State', 'wp-realestate' ),
		'update_item'                => __( 'Update State', 'wp-realestate' ),
		'separate_items_with_commas' => __( 'Separate states with commas', 'wp-realestate' ),
		'search_items'               => __( 'Search states', 'wp-realestate' ),
		'add_or_remove_items'        => __( 'Add or remove states', 'wp-realestate' ), 
		'choose_from_most_used'      => __( 'Choose from the most used states', 'wp-realestate' ),
	);
	$args2 = array(
		'labels'                     => $labels2,
		'hierarchical'               => false,
...
die('Permission denied...');
	...
	if($do == 'update_et_options'){	
		...
		update_option('et_re_sent_copy_email', $_REQUEST['et_re_sent_copy_email']);
		...
		if (file_exists( ET_RE_PATH . 'pro/pro_etechyrealestate.php')) { include ET_RE_PATH . 'pro/pro_etechyrealestate.php'; }
