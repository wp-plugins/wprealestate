...
<br style="clear:both;" />
<div class="AdmfrmLabel">
  <label for="et_er_built_size"><?php _e( 'Built upto', 'wp-realestate' ); ?></label>
</div>
<div class="AdmfrmFld">
  <input name="et_er_built_size" type="text" id="et_er_built_size" value="<?php echo $et_er_built_size; ?>" size="14" />
  <br />
<?php _e( 'Only numbers', 'wp-realestate' ); ?></div>
<br style="clear:both;" />
<div class="AdmfrmLabel">
...
<br style="clear:both;" />
<div class="AdmfrmLabel">
  <label for="et_er_price"><?php _e( 'Price', 'wp-realestate' ); ?></label>
</div>
<div class="AdmfrmFld">
  <input name="et_er_price" type="text" id="et_er_price" value="<?php echo $et_er_price; ?>" size="14" />
  <br />
  <?php _e( 'Only numbers', 'wp-realestate' ); ?>
</div>
<br style="clear:both;" />
<div class="AdmfrmLabel">
