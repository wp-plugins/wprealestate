...
<form id="advncsrc" class="pfs frmshow" method="post" action="<?php echo get_permalink($et_re_pg_pro_list); ?>">
                ...
                <div class="clr"></div>
                <?php if (in_array("p_list_type", $et_re_adv_flds)) {?>
...
<label class="labelbig">Price </label>
                ...
                <?php /*?><select name="p_minprice" class="cstm_s_big" id="p_minprice" style="width:60px;">
                    <option selected="selected" value="">Min</option>
                    <option value="200000"><?php echo ET_RE_Currency; ?> 200,000</option>
                    <option value="300000"><?php echo ET_RE_Currency; ?> 300,000</option>
                    <option value="400000"><?php echo ET_RE_Currency; ?> 400,000</option>
                    <option value="500000"><?php echo ET_RE_Currency; ?> 500,000</option>
                    <option value="600000"><?php echo ET_RE_Currency; ?> 600,000</option>
                    <option value="700000"><?php echo ET_RE_Currency; ?> 700,000</option>
                    <option value="800000"><?php echo ET_RE_Currency; ?> 800,000</option>
                    <option value="900000"><?php echo ET_RE_Currency; ?> 900,000</option>
                    <option value="1000000"><?php echo ET_RE_Currency; ?> 1,000,000</option>
                    <option value="1250000"><?php echo ET_RE_Currency; ?> 1,250,000</option>
                    <option value="1500000"><?php echo ET_RE_Currency; ?> 1,500,000</option>
                    <option value="2000000"><?php echo ET_RE_Currency; ?> 2,000,000</option>
                    <option value="2500000"><?php echo ET_RE_Currency; ?> 2,500,000</option>
                    <option value="3000000"><?php echo ET_RE_Currency; ?> 3,000,000</option>
                    <option value="4000000"><?php echo ET_RE_Currency; ?> 4,000,000</option>
                    <option value="5000000"><?php echo ET_RE_Currency; ?> 5,000,000</option>
                    <option value="6000000"><?php echo ET_RE_Currency; ?> 6,000,000</option>
                    <option value="8000000"><?php echo ET_RE_Currency; ?> 8,000,000</option>
                    <option value="10000000"><?php echo ET_RE_Currency; ?> 10,000,000</option>
                    <option value="15000000"><?php echo ET_RE_Currency; ?> 15,000,000</option>
                    <option value="20000000"><?php echo ET_RE_Currency; ?> 20,000,000</option>
                    <option value="30000000"><?php echo ET_RE_Currency; ?> 30,000,000</option>
                    <option value="50000000"><?php echo ET_RE_Currency; ?> 50,000,000</option>
                </select><?php */?>
                <input style="width:50px;" type="text" name="p_maxprice" id="p_maxprice" maxlength="7" />
                <?php /*?><select name="p_maxprice" class="cstm_s_big" id="p_maxprice" style="width:60px;">
                    <option selected="selected" value="">Max</option>
                    <option value="200000"><?php echo ET_RE_Currency; ?> 200,000</option>
                    <option value="300000"><?php echo ET_RE_Currency; ?> 300,000</option>
                    <option value="400000"><?php echo ET_RE_Currency; ?> 400,000</option>
...
<label>City</label>
                <input name="sbpn" onfocus="if (this.value == 'Search by City') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search by City';}" class="cstm_f_large" id="sbpn" value="Search by City" />
                <div class="rspbreak"></div>
                <?php } ?>
