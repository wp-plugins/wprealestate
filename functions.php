...
<label>City</label>
                <input name="p_city" class="cstm_f_large" id="sbpn" value="" />
                <div class="rspbreak"></div>
                <?php } ?>
                <?php if (in_array("et_er_ref_num", $et_re_adv_flds)) {?>
<label>Reference #</label>
                <input name="et_er_ref_num" class="cstm_f_large" id="sbpn" value="" />
                <div class="rspbreak"></div>
                <?php } ?>
