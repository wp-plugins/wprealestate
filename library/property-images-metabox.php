...
function list_property_images( $ptyimg = false ){
	$list_images = apply_filters('list_images',array(
		'property_image1' => '_property_image1',
		'property_image2' => '_property_image2',
		'property_image3' => '_property_image3',
		'property_image4' => '_property_image4',
		'property_image5' => '_property_image5',
		), $ptyimg );
	return $list_images;
}
