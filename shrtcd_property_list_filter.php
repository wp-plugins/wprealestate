...
<h2 class="h2typelist"><a href="'. get_permalink($propertyQuery->ID) .'">'. $propertyQuery->post_title.'</a></h2>';
	  ...
	  $pro_return .= translate( 'Property ID: ', 'wp-real-estate' ).$propertyQuery->ID.'<br>';
	  }
	  ...
	  $pro_return .= translate( 'Bathrooms: ', 'wp-real-estate' ).get_post_meta($propertyQuery->ID, 'et_er_bathroom', true).'<br>';
      }
