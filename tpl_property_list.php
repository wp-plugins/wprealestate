...
<div class="container site-content agtpglist">
  <h1 style="margin-top: 22px;">
    <?php _e( 'Property Listing', 'wp-realestate' ); ?>
...
?>
  <div class="Propertylstview">
    ...
    <div class="prlinfo">
      ...
      <a href="<?php echo get_permalink($propertyQuery->ID); ?>" class="prlviewbtn"><?php _e( 'View Details', 'wp-realestate' ); ?></a> </div>
    <br style="clear:both;">
  </div>
  <?php
  } 
...
?>
  <div class="Propertylstview">
    ...
    <div class="prlinfo">
      ...
      <?php _e( 'For Rent', 'wp-realestate' ); ?> : <?php echo ET_RE_Currency.get_post_meta(get_the_ID(), 'et_er_rent_price', true).' '.get_post_meta(get_the_ID(), 'et_er_rent_tenure', true); ?>
      <?php } else {  ?>
      <?php _e( 'For Sale', 'wp-realestate' ); ?> : <?php echo ET_RE_Currency.get_post_meta(get_the_ID(), 'et_er_price', true); ?><br>
      <?php } ?></h3>
      <ul>
        <?php if (get_post_meta(get_the_ID(), 'et_er_built_size', true) <> '0') { ?>
		<li><?php _e( 'Built Up', 'wp-realestate' ); ?>: <?php echo get_post_meta(get_the_ID(), 'et_er_built_size', true); ?></li>
      	<?php } ?>
        <?php if (get_post_meta(get_the_ID(), 'et_er_bedroom', true) <> '0') { ?>
      <li class="prlinfobed"><?php _e( 'Bedrooms', 'wp-realestate' ); ?>: <?php echo get_post_meta(get_the_ID(), 'et_er_bedroom', true); ?></li>
      <?php }
	  if (get_post_meta(get_the_ID(), 'et_er_bathroom', true) <> '0') { ?>
      <li class="prlinfobath"><?php _e( 'Bathrooms', 'wp-realestate' ); ?>: <?php echo get_post_meta(get_the_ID(), 'et_er_bathroom', true); ?></li>
      <?php } ?>
        
      </ul>
      <div style="clear:both"></div>
      <a href="<?php the_permalink(); ?>" class="prlviewbtn"><?php _e( 'View Details', 'wp-realestate' ); ?></a> </div>
    <br style="clear:both;">
  </div>
  <!-- pagination -->
  <?php 
