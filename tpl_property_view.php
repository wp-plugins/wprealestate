...
if ($_POST) {
	...
	sendmail($_REQUEST['inq_name'], $et_re_agent_email, $_REQUEST['inq_email'], __( 'Message from', 'wp-realestate' ).' '.bloginfo('name'),$inq_msg);
...
<div class="SpecInfo"><?php echo get_post_meta($post->ID, 'et_er_rent_price', true).' '. get_post_meta($post->ID, 'et_er_rent_tenure', true) .'<br />'; ?></div>
<?php }
